class Question {
  ...
  display(){
    ...
    this.question.html("Question:- Who is the present CEO of the company 'Apple' ? " );
    // question.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );

    this.question.position(150, 80);
    this.option1.html("1: Bill Gates " );
    this.option1.position(150, 100);
    this.option2.html("2: Jeff Bezos" );
    this.option2.position(150, 120);
    this.option3.html("3: Tim Cook " );
    this.option3.position(150, 140);
    this.option4.html("4: Steve Jobs" );
